...
//登录接口 生成token的方法
var setToken = function(_id, loginame,  nickname, avatar, defaultCampus) {
    return new Promise((resolve, reject) => {
        ...
        const rule = { _id: _id, loginame: loginame, nickname: nickname,  avatar: avatar, defaultCampus: defaultCampus || null };
